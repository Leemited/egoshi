...
public class BluetoothLeService extends Service {
    ...
    private void broadcastUpdate(final String action,
        ...
        if (UUID_HEART_RATE_MEASUREMENT.equals(characteristic.getUuid())) {
        	...
        	Log.d(TAG, "UUID_FBL770_INIT_SETTING"+ characteristic.getUuid());
        	...
        	Log.d(TAG, "UUID_FBL770_PIOREAD_NOTIFY" + characteristic.getUuid());
        	...
        	Log.d(TAG, "UUID_FBL770_ADC0_NOTIFY" + characteristic.getUuid());
        	...
        	Log.d(TAG, "UUID_FBL770_ADC1_NOTIFY" + characteristic.getUuid());
            ...
            if (data != null && data.length > 0) {
                ...
                Log.d(TAG, "broadcastUpdate: " + sendByte );
        	...
        	Log.d(TAG, "UUID_FBL770_SPP_NOTIFY" + characteristic.getUuid());
            ...
            if (data != null && data.length > 0) {
                ...
                Log.d(TAG, "broadcastUpdate: " + sendByte.toString() );
                intent.putExtra("init", sendByte);
                intent.putExtra(EXTRA_DATA, stringBuilder.toString());
            }        	
        }          
...
///    	mNotifyCharacteristic.setValue(strValue.getBytes());
        ...
        TotalByteMessage = strValue.getBytes();

        String byteToString = new String(TotalByteMessage,0,TotalByteMessage.length);

        Log.d(TAG, "writeCharacteristics: " + byteToString);
    }
